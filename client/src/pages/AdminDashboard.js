...
const AdminDashboard = () => {
  ...
  const handleCancelOrder = async (orderId) => {
    try {
      const response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/admin/orders/${orderId}/cancel`);
  ...
  const handleGetCancelRequests = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/admin/agents/cancel-requests`);
      if (response.data.success) {
  ...
  const handleConfirmOrder = async (orderId) => {
    try {
      const response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/admin/orders/${orderId}/confirm`);
      if (response.data.success) {
  ...
  const { data: dashboardData, isLoading: dashboardLoading } = useQuery("admin-dashboard", async () => {
    const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/admin/dashboard`)
  ...
  const { data: ordersData, isLoading: ordersLoading } = useQuery("admin-orders", async () => {
    const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/admin/orders`)
    return response.data
  })
  ...
  const updateProductMutation = useMutation(
    async ({ productId, productData }) => {
      const response = await axios.put(`${process.env.REACT_APP_BASE_URL}/api/products/${productId}`, productData)
      return response.data
    },
    {
      onSuccess: () => {
  ...
  const updateOrderStatusMutation = useMutation(
    async ({ orderId, status }) => {
      const response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/admin/orders/${orderId}/status`, { status })
      return response.data
    },
    {
      onSuccess: () => {
  ...
  const getAgentsData = async () => {
    ...
    const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/admin/agents`);
    if (response.data.success) {
      let Agents = [];
  ...
  const getAdminData = async () => {
    ...
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/auth/admin-data`);
      if (response.data.success) {
  ...
  const handleUpdateAdminStatus = async (id, status) => {
    await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/auth/admin/${id}/status`, { status });
    getAdminData();
  }
  ...
  const handleUpdateAgentStatus = async (agentId, newStatus) => {
    ...
    if (newStatus === "verified") {
      response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/admin/agents/${agentId}/verify`);
    }
    else {
      response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/api/admin/agents/${agentId}/reject`);
    }
    if (response.data.success) {
