...
export default function DeliveryAgentProfile() {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/auth/profile`, { withCredentials: true });
      if (response.data.success) {
  ...
  const handleSave = () => {
    ...
    const updateProfile = async () => {
      const response = await axios.put(`${process.env.REACT_APP_BASE_URL}/api/auth/profile`, editData, { withCredentials: true });
      if (response.data.success) {
