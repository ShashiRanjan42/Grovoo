...
const PaymentModal = ({ isOpen, onClose, orderData, onSuccess }) => {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/payment/create-order`, orderData)
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            ...
            const verifyResponse = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/payment/verify-payment`, {
            ...
            await axios.post(`${process.env.REACT_APP_BASE_URL}/api/payment/payment-failed`, {
              dbOrderId,
  ...
  const handleCODPayment = async () => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/orders`, {
        ...orderData,
        paymentMethod: "cod",
      })
